...
def display_scroll(name, silent=False):
    ...
    if not restarting:
        ...
        double_prev_position = (prev_position[0] - 40, og_logo_position[1])
        double_next_position = (next_position[0] + 40, og_logo_position[1])
        ...
        draw.rectangle([og_logo_position[0] - 2, og_logo_position[1] - 2, og_logo_position[0]+96 + 2, og_logo_position[1]+96 + 2], outline=WHITE, width=3) # border
