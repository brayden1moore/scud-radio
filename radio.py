...
def display_everything(direction, name, update=False, readied=False, pushed=False):
    ...
    if readied and not restarting:
        ...
        if readied:
            ...
            total_span = SCREEN_WIDTH - (1.5 * padding)
            ...
            if favorites:
                tick_color = BLACK
                draw.rectangle([square_start, tick_bar_start + 5, square_end, tick_bar_start - 4 + tick_bar_height], fill=YELLOW, outline=YELLOW, width=1)
