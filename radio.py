...
def display_everything(direction, name, update=False, readied=False, pushed=False):
    ...
    if readied and not restarting:
        ...
        draw.rectangle([name_chunk_start_x, name_chunk_start + 26, name_chunk_start_x + width(name_line[0], LARGE_FONT_THIN), name_chunk_start + 26], fill=WHITE) # ul
