...
og_logo_position = (114, logo_chunk_start - 14 - 14)
...
tick_start = 0  
tick_bar_height = 25
tick_bar_start = logo_chunk_start + 90 - 3
tick_height = 1
...
def display_scroll(name, silent=False):
    ...
    if not restarting:
        ...
        prev_position = (og_logo_position[0] - 70, og_logo_position[1] - 2)
        next_position = (og_logo_position[0] + 70, og_logo_position[1] - 2)        
        ...
        double_prev_position = (prev_position[0] - 40, prev_position[1] - 2)
        double_next_position = (next_position[0] + 40,  prev_position[1] - 2)
